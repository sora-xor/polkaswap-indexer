...
ENV NODE_ENV=production \
    ...
    MOBILE_NEXUS_AVAILABLE=false \
    MOBILE_NEXUS_SENDS_AVAILABLE=false \
    MOBILE_POLKAMARKT_VISIBLE=false \
    MOBILE_POLKAMARKT_MUTATIONS_AVAILABLE=false \
    MOBILE_TAIRA_DEFAULT_VISIBLE=true \
